...
# Policy to allow peering acceptance
...
# Role that can be assumed by infra account
...
# Group that can accept peering connections
...
# Group policy that can assume role
